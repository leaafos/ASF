  ...
  return (
    <div>
        <div className='header-contact'>
            <img src={BandeauContact} alt="bandeau" ></img> {/*potentiellement mettre l'image en background dans le css*/}
        </div>
        <div className='contact-info'>
            <div className='infos-gauche'>
                <h3>NOUS CONTACTER</h3>
                <p>Association Sportive Fontenaisienne, club omnisports.<br /> 24 sections sportives à Fontenay-Aux-Roses, Haut de Seine</p>
