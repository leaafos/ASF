    ...
    <div>
      ...
      <div className='histoire'>
        <div className='texte-histoire'>
          ...
          <p>Elle compte aujourd'hui plus de 3 600 adhérents, porpose près de 30 activités sportives différentes et met en place des projets, des compétitions, des activités handisports, des animations, des spectacles... seule ou en partenariat avec d'autres associations et/ou les services municipaux de la ville de Fontenay-aux-Roses.</p>
        </div>
        ...
        <div className='phrise'>
          ...
          <div className='elements-phrise'>
            <div className='point'>
                <img src={Barre}></img>
                <h5>1961 - 1982</h5>
                <span><b>Julien Vuillaume</b></span>
            </div>
            <div className='point'>
                <img src={Barre}></img>
                <h5>1982 - 1986</h5>
                <span><b>Jean-Jacques Cirerone</b></span>
            </div>
            <div className='point'>
                <img src={Barre}></img>
                <h5>1986 - 1990</h5>
                <span><b>Jean Soyer</b></span>
            </div>
            <div className='point'>
                <img src={Barre}></img>
                <h5>1990 - 2019</h5>
                <span><b>Claude Boutang</b></span>
            </div>
            <div className='point'>
                <img src={Barre}></img>
                <h5>2019 - Aujourd'hui</h5>
                <span><b>Dominique Dussert-Ernard</b></span>
            </div>
        </div>
        </div>
